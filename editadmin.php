...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">EDIT ADMINS</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editadmin2.php">
    <p>EMAIL :</p>
    ...
    <p>PASSWORD :</p>
    <div class="form-group">
        <input type="text" name="pass" value="<?php echo htmlspecialchars($row['pass']); ?>">
    </div>
