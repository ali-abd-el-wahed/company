    ...
    isset($_GET['amount']) && ($_GET['amount'] != ""))
{
    ...
    $kitName = mysqli_real_escape_string($con, $_GET['kitName']);
    ...
    $query = "INSERT INTO `costumer2`(`name`, `email`, `phone`, `jersey`, `number`, `kit_name`, `quantity`, `cnumber`, `total_price`) VALUES ('$name','$email','$phone','$kit','$number','$kitName','$quantity','$ccNB','$amount')";
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">DESIGN YOUR SHIRT NOW FOR ONLY 50 $ !</h1>
            <p>choose your favorite jersey <br> and click order !</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
            <form action="shirt2.php" method="GET">
            <h1 class="text-white">DESIGN YOUR OWN STYLE : </h1>
            <h4 >BACK TO THE OLD PAGE FROM <a href="shirt.php">HERE</a></h4><br>
            <div class="form-group">
              ...
              <div class="form-group">
                <input type="number" class="form-control" placeholder="Your Number" name="number"required>
              </div>
              <p>ENTER YOUR JERSEY NAME:</p>
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Your name" name="kitName"required>
              </div>
              <p>ENTER THE QUANTITY :</p>
               <div class="form-group">
             <input type="number" name="quantity" class="form-control" placeholder="quantity" id="quantity" value="1" oninput="updateTotalPrice()" required>
            </div>       
  ...
  <input type="text" id="amount" name="amount" placeholder="amount" value="$50.00" readonly>
          ...
          <div class="col-lg-4 ml-auto">
            ...
            <ul class="list-unstyled">
              ...
              <li class="mb-2">
                <strong class="text-white d-block"></strong><br>
                
"Unleash your creativity and imprint your unique style onto our club's iconic shirt design. Express your footballing soul and leave an indelible mark on the pitch as you wear a jersey that embodies both your individuality and our collective team spirit. Together, we craft a visual symphony that resonates with every pass, goal, and victory."
              </li>
              <br>
