...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">EDIT CONTACTER</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editcontact2.php">
      <p>NAME :</p>
    ...
    <p>MESSAGE :</p>
    <div class="form-group">
        <input type="text" name="message" value="<?php echo htmlspecialchars($row['message']); ?>">
    </div>
