      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">VIEW CONTACTERS</h1>
          </div>
        </div>
      </div>
    </div>
...
for ($i = 0; $i < $nbr; $i++) {
    ...
    echo '<td><a href="editcontact.php?email=' . $row['email'] . '"><img src="edit.png" alt="edit"></a></td>';
    echo '<td><a href="deletecontact.php?email=' . $row['email'] . '"><img src="drop.png" alt="delete"></a></td>';
