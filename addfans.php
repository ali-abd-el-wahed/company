        ...
        &&  isset($_GET['dob']) && ($_GET['dob']!=""))
{
    ...
    $query="INSERT INTO `fan`(`fanId`, `name`, `email`, `pass`, `Dob`) VALUES ('NULL','$name','$email','$pass','$dob')";
    //echo $query;
    ...
    {
        echo("a new fan has been inserted successfully");
    } }
}
?>
<!DOCTYPE html>
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">ADD FAN</h1>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
            <form action="addfans.php" method="GET">
              ...
              <p>PASSWORD :</p>
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Password" minlength="8" name="pass" required>
              </div>
              <p>DATE OF BIRTH :</p>
              <div class="form-group">
                <input type="date" class="form-control" placeholder="Your birthdate" name="dob" required>
              </div>
              <div class="form-group">
                <input type="submit" class="btn btn-primary py-3 px-5" value="ADD FAN">
              </div>
            </form>  
          </div>
