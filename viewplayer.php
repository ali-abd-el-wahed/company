      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">VIEW players</h1>
          </div>
        </div>
      </div>
    </div>
...
for ($i = 0; $i < $nbr; $i++) {
    ...
    echo '<td><a href="editplayer1.php?number=' . $row['number'] . '"><img src="edit.png" alt="edit"></a></td>';
    echo '<td><a href="deleteplayer.php?number=' . $row['number'] . '"><img src="drop.png" alt="delete"></a></td>';
