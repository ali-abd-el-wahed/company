...
)
{
  ...
  $type=$_GET['type'];
    ...
    $query = "INSERT INTO `shirts`(`season`, `type`) VALUES ('$season', '$type')";
    ...
    {
        echo("a new shirt has been inserted successfully");
    } 
}}
?>
<!DOCTYPE html>
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">ADD SHIRT</h1>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
            <form action="addshirt.php" method="GET">
              <div class="form-group">
              <p>SEASON :</p> 
                <input type="text" class="form-control" placeholder="season" name="season"required>
              </div>
              <p>TYPE :</p>
              <div class="form-group">
