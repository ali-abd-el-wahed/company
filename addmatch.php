        ...
        && isset($_GET['comp']) && ($_GET['comp']!=""))
{
  ...
  $stad=$_GET['stad'];
    ...
    $query = "INSERT INTO `matches`(`oppenent`, `stadium`, `date`, `competition`) VALUES ('$opp', '$stad', '$date', '$comp')";
    ...
    {
        echo("a new match has been inserted successfully");
    } 
}}
?>
<!DOCTYPE html>
        ...
        <div class="row">
          <div class="col-lg-7">
            <form action="addmatch.php" method="GET">
              ...
              <p>OPPENENT :</p> 
                <input type="text" class="form-control" placeholder="Oppenent" name="opp"required>
              </div>
              <p>STADIUM :</p>
              <div class="form-group">
                <input type="text" class="form-control" placeholder="stadium" name="stad"required>
              </div>
              <p>DATE:</p>
              <div class="form-group">
                <input type="date" class="form-control" placeholder="Match date"  name="date" required>
              </div>
              <p>COMPETITION :</p>
               <div class="form-group">
             <input type="text" class="form-control" name="comp" placeholder="Competiton"required>
            </div>       
