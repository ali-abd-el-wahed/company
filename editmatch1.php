...
$oppenent = mysqli_real_escape_string($con, $_GET['oppenent']); // Sanitize input
$query = "SELECT * FROM `matches` WHERE oppenent = '$oppenent'";
...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">EDIT MACTH</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editmatch2.php">
    <p>OPPONENT :</p>
    <div class="form-group">
        <input type="text" name="opp" value="<?php echo htmlspecialchars($row['oppenent']); ?>">
    </div>
    <p>STADIUM :</p>
    <div class="form-group">
        <input type="text" name="stad" value="<?php echo htmlspecialchars($row['stadium']); ?>">
    </div>

    <p>DATE :</p>
    <div class="form-group">
        <input type="date" name="date" value="<?php echo htmlspecialchars($row['date']); ?>">
    </div>

    <p>COMPETITION :</p>
    <div class="form-group">
        <input type="text" name="comp" value="<?php echo htmlspecialchars($row['competition']); ?>">
    </div>
