      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">VIEW MATCHES</h1>
          </div>
        </div>
      </div>
    </div>
...
for ($i = 0; $i < $nbr; $i++) {
    ...
    echo "<tr>";
    echo "<td>$row[oppenent]</td>";
    echo "<td>$row[stadium]</td>";
    echo "<td>$row[date]</td>";
    echo "<td>$row[competition]</td>";;
    echo '<td><a href="editmatch1.php?oppenent=' . $row['oppenent'] . '"><img src="edit.png" alt="edit"></a></td>';
    echo '<td><a href="deletematch.php?oppenent=' . $row['oppenent'] . '"><img src="drop.png" alt="delete"></a></td>';
