...
$query = "SELECT * FROM `donars` WHERE email = '$email'";
...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">EDIT DONOR</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editdonor2.php">
      <p>NAME :</p>
    <div class="form-group">
        <input type="text" name="name" size="20" value="<?php echo htmlspecialchars($row['name']); ?>">
    </div>
      <p>EMAIL :</p>
    <div class="form-group">
    ...
    <div class="form-group">
        <input type="text" name="cc" size="16" value="<?php echo htmlspecialchars($row['cardNB']); ?>">
    </div>
