      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">VIEW FANS</h1>
          </div>
        </div>
      </div>
    </div>
...
for ($i = 0; $i < $nbr; $i++) {
    ...
    echo "<tr>";
    echo "<td>$row[fanId]</td>";
    echo "<td>$row[name]</td>";
    echo "<td>$row[email]</td>";
    echo "<td>$row[pass]</td>";
    echo "<td>$row[Dob]</td>";
    echo '<td><a href="editfans.php?fanId=' . $row['fanId'] . '"><img src="edit.png" alt="edit"></a></td>';
    echo '<td><a href="deletefans.php?fanId=' . $row['fanId'] . '"><img src="drop.png" alt="delete"></a></td>';
