      ...
      )
{
  ...
  $cost=$_GET['cost'];
    ...
    $query = "INSERT INTO `sit`(`class`, `cost`) VALUES ('$class', '$cost')";
    ...
    {
        echo("a new sit has been inserted successfully");
    } 
}}
?>
<!DOCTYPE html>
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">ADD SIT</h1>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
            <form action="addsit.php" method="GET">
