...
$season = mysqli_real_escape_string($con, $_GET['season']); // Sanitize input
$query = "SELECT * FROM `shirts` WHERE season = '$season'";
...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editshirts2.php">
    <p>SEASON :</p>
    <div class="form-group">
        <input type="text" name="season" value="<?php echo htmlspecialchars($row['season']); ?>">
    </div>
    <p>TYPE :</p>
    <div class="form-group">
