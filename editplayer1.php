...
$number = mysqli_real_escape_string($con, $_GET['number']); // Sanitize input
...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">EDIT PLAYER</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editplayer2.php">
    <p>NUMBER :</p>
    <div class="form-group">
        <input type="text" name="numb" value="<?php echo htmlspecialchars($row['number']); ?>">
    </div>
    <p>NAME :</p>
    <div class="form-group">
    ...
    <p>LAST NAME :</p>
    <div class="form-group">
        <input type="text" name="last" value="<?php echo htmlspecialchars($row['last_name']); ?>">
    </div>
    <p>POSITION :</p>
    <div class="form-group">
        <input type="text" name="pos" value="<?php echo htmlspecialchars($row['position']); ?>">
    </div>
    <div class="form-group">
