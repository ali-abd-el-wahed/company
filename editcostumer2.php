...
$query = "SELECT * FROM `costumer2` WHERE email = '$email'";
...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">EDIT COSTUMER 2</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editcostumer22.php">
    <p>NAME :</p>
    ...
    <p>JERSEY :</p>
    <div class="form-group">
        <input type="text" name="kit" value="<?php echo htmlspecialchars($row['jersey']); ?>">
    </div>
    
    <p>NUMBER :</p>
    <div class="form-group">
        <input type="number" name="number" value="<?php echo htmlspecialchars($row['number']); ?>">
    </div>
    
    <p>NAME CHOOSEN :</p>
    <div class="form-group">
        <input type="text" name="kitName" value="<?php echo htmlspecialchars($row['kit_name']); ?>">
    </div>
    <p>QUANTITY :</p>
    <div class="form-group">
        <input type="number" name="quantity" id="quantity" oninput="updateTotalPrice()" value="<?php echo htmlspecialchars($row['quantity']); ?>">
    </div>

    <p>CREDIT CARD NUMBER :</p>
    <div class="form-group">
        <input type="text" name="cc" size="16" value="<?php echo htmlspecialchars($row['cnumber']); ?>">
    </div>

    <p>TOTAL PRICE :</p>
    <div class="form-group">
        <input type="text" name="total" id="amount" value="<?php echo htmlspecialchars($row['total_price']); ?>">
    </div>
...
<script>
    function updateTotalPrice() {
        ...
        var unitPrice = 50; // Change this to your actual unit price
