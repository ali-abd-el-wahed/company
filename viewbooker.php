      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">VIEW BOOKERS</h1>
          </div>
        </div>
      </div>
    </div>
...
for ($i = 0; $i < $nbr; $i++) {
    ...
    echo "<td>$row[match_stadium_date]</td>";
    echo "<td>$row[sit_cost]</td>";
    echo "<td>$row[cc]</td>";
    echo '<td><a href="editbooker.php?email=' . $row['email'] . '"><img src="edit.png" alt="edit"></a></td>';
    echo '<td><a href="deletebooker.php?email=' . $row['email'] . '"><img src="drop.png" alt="delete"></a></td>';
