        ...
        &&  isset($_GET['cc']) && ($_GET['cc']!=""))
{
  ...
  $email=$_GET['email'];
    ...
    $query="INSERT INTO `donars`(`name`, `email`, `phone_number`, `amount`, `cardNB`) VALUES ('$name','$email','$phone','$amount','$cc')";
    //echo $query;
    ...
    {
        echo("a new donor has been inserted successfully");
    } 
}}
?>
<!DOCTYPE html>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">ADD DONOR</h1>
        ...
        <div class="row">
          <div class="col-lg-7">
            <form action="adddonor.php" method="GET">
              ...
              <p>PHONE NUMBER :</p>
              <div class="form-group">
                <input type="text" class="form-control" placeholder="COUNTRY CODE - YOUR PHONE NUMBER" name="phone"required>
              </div>
        ...
        <div class="form-group">
         <input type="text" id="card_number" name="cc" placeholder="XXXX-XXXX-XXXX-XXXX" maxlength="16" required>
              ...
              <div class="form-group">
                ...
                <input type="submit" class="btn btn-primary py-3 px-5" value="ADD DONOR">
              </div>
            </form>  
          </div>
