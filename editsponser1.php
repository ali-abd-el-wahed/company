...
$brand_name = mysqli_real_escape_string($con, $_GET['brand_name']); // Sanitize input
$query = "SELECT * FROM `sponsers` WHERE brand_name = '$brand_name'";
...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">EDIT SPONSER</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editsponser2.php">
    <p>BRAND NAME :</p>
    <div class="form-group">
        <input type="text" name="brand_name" value="<?php echo htmlspecialchars($row['brand_name']); ?>">
    </div>
    <p>PHONE NUMBER :</p>
    <div class="form-group">
    ...
    <p>WEBSITE :</p>
    <div class="form-group">
        <input type="text" name="web" value="<?php echo htmlspecialchars($row['website']); ?>">
    </div>
    <div class="form-group">
