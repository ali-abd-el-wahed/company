        ...
        && isset($_POST['pass']) && $_POST['pass']!="")   
{
    ...
    $query="SELECT * FROM fan WHERE email='$email' AND  pass='$pass'" ;
          ...
          <div class="ml-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="active"><a href="loginClient.php" class="nav-link">LG for FAN </a></li>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">LOG IN AS A FAN  !</h1>
            <p>HAVE AN ACCOUNT ??<br> LOGIN FROM HERE !!!!</p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-lg-7">
            ...
            <p>EMAIL :</p>
              ...
              <div class="form-group">
                <input type="submit" class="btn btn-primary py-3 px-5" value="LOG IN!"> Don't have an account ? register from <a href=registration.php>HERE</a>
              </div>
            </form> 
            </div>
