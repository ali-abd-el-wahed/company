        ...
        )
{
  ...
  $web=$_GET['web'];
    ...
    $query = "INSERT INTO `sponsers`(`brand_name`, `phone`,`website`) VALUES ('$brand', '$phone','$web')";
    ...
    {
        echo("a new sponser has been inserted successfully");
    } 
}}
?>
<!DOCTYPE html>
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">ADD SPONSER</h1>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-7">
            <form action="addsponser.php" method="GET">
              ...
              <p>WEBSITE:</p>
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Website" name="web"required>
              </div>    
<br>

   
              <div class="form-group">
                <input type="submit" class="btn btn-primary py-3 px-5" value="ADD">
              </div>
            </form>  
          </div>
