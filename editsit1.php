...
$class = mysqli_real_escape_string($con, $_GET['class']); // Sanitize input
$query = "SELECT * FROM `sit` WHERE class = '$class'";
...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">EDIT SIT</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editsit2.php">
    <p>CLASS :</p>
    <div class="form-group">
        <input type="text" name="class" value="<?php echo htmlspecialchars($row['class']); ?>">
    </div>
    <p>NAME :</p>
    <div class="form-group">
        <input type="text" name="cost" value="<?php echo htmlspecialchars($row['cost']); ?>">
    </div>
    <div class="form-group">
