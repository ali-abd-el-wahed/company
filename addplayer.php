        ...
        && isset($_GET['pos']) && ($_GET['pos']!=""))
{
  ...
  $name=$_GET['name'];
    ...
    $query = "INSERT INTO `players`(`number`, `name`, `last_name`, `position`) VALUES ('$numb', '$name', '$last', '$pos')";
    ...
    {
        echo("a new player has been inserted successfully");
    } 
}}
?>
<!DOCTYPE html>
        ...
        <div class="row">
          <div class="col-lg-7">
            <form action="addplayer.php" method="GET">
              ...
              <p>NUMBER :</p> 
                <input type="text" class="form-control" placeholder="Shirt Number" name="numb"required>
              </div>
              <p>NAME :</p>
              <div class="form-group">
