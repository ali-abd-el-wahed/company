...
$query = "SELECT * FROM `bookers` WHERE email = '$email'";
...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">EDIT BOOKER</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editbooker2.php">
    <p>EMAIL :</p>
    <div class="form-group">
        <input type="text" name="email" size="20" value="<?php echo htmlspecialchars($row['email']); ?>">
    </div>

    <p>MATCH - STADIUM (DATE) :</p>
    <div class="form-group">
        <input type="text" name="match" value="<?php echo htmlspecialchars($row['match_stadium_date']); ?>">
    </div>

    <p>SIT - COST :</p>
    <div class="form-group">
        <input type="text" name="sit" value="<?php echo htmlspecialchars($row['sit_cost']); ?>">
    </div>

    <p>CREDIT CARD NUMBER :</p>
    <div class="form-group">
        <input type="text" name="cc" size="16" value="<?php echo htmlspecialchars($row['cc']); ?>">
    </div>
