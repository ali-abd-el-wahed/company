      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">VIEW SHIRTS</h1>
          </div>
        </div>
      </div>
    </div>
...
for ($i = 0; $i < $nbr; $i++) {
    ...
    echo "<td>$row[type]</td>";
    echo '<td><a href="editshirt1.php?season=' . $row['season'] . '"><img src="edit.png" alt="edit"></a></td>';
    echo '<td><a href="deleteshirt.php?season=' . $row['season'] . '"><img src="drop.png" alt="delete"></a></td>';
