...
$query = "SELECT * FROM `costumer1` WHERE email = '$email'";
...
<body>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-9 mx-auto text-center">
            <h1 class="text-white">EDIT COSTUMER 1</h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-7">
      <form method="GET" action="editcostumer12.php">
    <p>NAME :</p>
    ...
    <p>PHONE NUMBER :</p>
    <div class="form-group">
        <input type="text" name="phone" value="<?php echo htmlspecialchars($row['phone_number']); ?>">
    </div>

    <p>PLAYER :</p>
    <div class="form-group">
        <input type="text" name="player" value="<?php echo htmlspecialchars($row['player']); ?>">
    </div>
    <p>JERSEY :</p>
    <div class="form-group">
